    ...
    try {
        const products = yield product_model_1.default.findAll({
            include: [
                ...
                {
                    model: productGallery_model_1.default,
                    as: 'galleries',
                },
            ],
        });
        ...
        res.status(500).json({ message: 'Failed to fetch products with relations' });
    }
});
...
const product = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.error('Error fetching product by ID with relations from body:', error);
        res.status(500).json({ message: 'Failed to fetch product with relations' });
    }
});
